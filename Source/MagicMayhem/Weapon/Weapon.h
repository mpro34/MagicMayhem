...
UCLASS()
class MAGICMAYHEM_API AWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	class AMagiCharacter* OwningCharacter;

	UPROPERTY()
	class AMagiPlayerController* OwningController;
...
private:
	...
	// The number of unprocesses server requests for Ammo.
